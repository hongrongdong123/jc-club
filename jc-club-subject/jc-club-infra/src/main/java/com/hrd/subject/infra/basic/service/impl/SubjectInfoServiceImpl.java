...
import com.hrd.subject.infra.basic.mapper.SubjectInfoDao;
...
public class SubjectInfoServiceImpl implements SubjectInfoService {
    ...
    public List<SubjectInfo> queryPage(SubjectInfo subjectInfo, Long categoryId, Long labelId, int start, Integer pageSize) {
        List<SubjectInfo> list = this.subjectInfoDao.queryPage(subjectInfo, categoryId, labelId, start, pageSize);
        return list;
    }
